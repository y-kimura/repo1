...
//delegation pattern
public class TagTreeCellEditor extends AbstractCellEditor implements TreeCellEditor {
		...
		@Override public Component getTreeCellEditorComponent(JTree tree, Object value, boolean selected, boolean expanded, boolean leaf, int row) {
			checkBoxNode = (TagTreeNode)((DefaultMutableTreeNode) value).getUserObject();
